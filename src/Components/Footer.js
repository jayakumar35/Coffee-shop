...
function Footer() {
    return (
        <Container style={{ maxWidth: '1550px' }} className="Footer-container">
            <Row>
                <Col sm={12} md={3} lg={3}>
                    <div class="foodter">
                        <ul type="none">
                            <li><b>GET IN TOUCH</b></li>
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-geo-alt"
                                viewBox="0 0 16 16">
                                <path
                                    d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10" />
                                <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
                            </svg>123 STREET, COIMBATOER</li>
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                ...
                <Col sm={12} md={3} lg={3}>
                        <div class="foodter">
                            <ul type="none">
                                <li><b>FOLLOW US</b></li>
                                <li>Amet elitr vero magna sed ipsum sit kasd sea elitr lorem rebum</li>
                                <li class="sclmdi">
                ...
                <Col sm={12} md={3} lg={3}>
                        <div class="foodter">
                            <ul type="none">
                                <li><b>OPEN HOURS</b></li>
                                <li>MONDAY-FRIDAY</li>
                                <li>8.00 AM-8.00 PM</li>
                                <li>SATURDAY-SUNDAY</li>
                                <li>2.00 PM-8.00PM</li>
                            </ul>
                        </div>
